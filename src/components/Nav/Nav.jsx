        ...
        <nav className="nav-bar">
            ...
            <div className="lower-nav">
                <ul className="lower-nav-ul">
                    ...
                    <li className="trigger"><a href="/#">About Simpsons</a>
                        <ul className="submenu">
                            <li><a href="/#">Link 1</a></li>
                        </ul>
                    </li>
                    <li className="trigger"><a href="/#"> Accessories</a>
                        <ul className="submenu">
                            <li><a href="/#">Link 1</a></li>
                        </ul>
                    </li>
                    <li className="trigger"><a href="/#"> Tops</a>
                        <ul className="submenu">
                            <li><a href="/#">Link 1</a></li>
                        </ul>
                    </li>
                    <li className="trigger"><a href="/#">Snacks</a>
                        <ul className="submenu">
                            <li><a href="/#">Link 1</a></li>
                        </ul>
                    </li>
                    <li className="trigger"><a href="/#"> Shoes</a>
                        <ul className="submenu">
                            <li><a href="/#">Link 1</a></li>
                        </ul>
                    </li>
